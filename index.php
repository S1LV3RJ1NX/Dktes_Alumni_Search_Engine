  ...
  <body>
	...
	<div class="jumbotron">
		<div style="text-align: center;">
			<h1 class="display-4">Alumni Search Engine </h1>
	  		<p class="lead">This website contains info about alumni of DKTE Institute.</p>
	  		<hr class="my-4">
	  			<p>To get more info about them login or create an account on this site!</p>
	  		<p class="lead">
