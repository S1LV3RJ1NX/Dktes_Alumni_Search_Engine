...
<body>
	...
	<a class="navbar-brand" href="#" style="padding-left: 3%">DKTES Admin Portal </a>
	...
	<div class="container-fluid" style="padding-left: 10%">
				...
				<fieldset>
					<div class="form-row">
			            ...
			            <div class="form-group col-md-2">
			                ...
			                <button class="btn btn-primary" type="submit" name="all">Get All</button>
			            </div>
			       </div>
		   </fieldset>
		</form>
		...
		if(isset($_POST["all"]))
		{
			$sql = "SELECT id, fname, lname, email, company, dept, passout FROM alumni_info;";
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				echo '<div class="table-responsive table-hover">' ;
					...
					echo '<thead class="thead-dark">';
						echo '<tr class="text-center">';
							echo ' <th scope="col">Check <input type="checkbox" id="selectAll"/></th> ';
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<tr class="text-center">';
						echo '<th scope="row"><input type="checkbox" class="checkBoxClass" name="mailid[]" value="'.$row['email'].'"></th>';
				...
				echo '<div class="form-group row"  >
					<div class="offset-sm-2 col-sm-10"  >
						<button class="btn btn-primary" type="submit" name="sendmail" style="margin-top: -5%; margin-left: 30%; display: block;">Send Mail</button>
					</div>
				</div>';
